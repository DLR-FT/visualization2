...
<boot version="2.12.0.2" autosave="0">
	...
	<system_script>SimVis/unigine.usc</system_script>
	<editor_script/>
	<cache_path/>
	...
	<plugin_paths/>
	<extern_plugins>
		<plugin>AssimpImporter</plugin>
		<plugin>GltfImporter</plugin>
	</extern_plugins>
	<console>
		...
		<starting_world>SimVis/SimVis.world</starting_world>
	...
	<screen>
		...
		<texture>configs/splash.png</texture>
		<text></text>
		<messages>
			<engine_init>Initialization engine</engine_init>
			<file_system_init>Initializing file system interface</file_system_init>
			<materials_init>Initialization materials handler</materials_init>
			<properties_init>Initialization properties</properties_init>
			<plugins_init>Initialization plugins system</plugins_init>
			<shaders_compilation>Compiling shaders</shaders_compilation>
		</messages>
	</screen>
</boot>
